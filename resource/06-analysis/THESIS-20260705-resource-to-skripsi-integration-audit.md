...
| Koding wawancara dan temuan lapangan utama | `resource/05-fieldwork/07-rekap-koding/W-INT-20260704-koding-temuan-lapangan-lengkap.md`; `resource/05-fieldwork/01-wawancara/20260706-wawancara-pemilik/compiled/analysis/W-PM-20260706-rekap.md` | Sudah masuk sebagai ringkasan koding pemilik, pegawai, business consultant, kompetitor, pelanggan, faktor SWOT, IFAS/EFAS, SWOT, dan prioritas strategi. | Bab IV: `Hasil Wawancara, Observasi, dan Angket`; `Identifikasi Faktor Internal dan Eksternal`; `Matriks IFAS dan EFAS`; `Matriks SWOT`; `Prioritas Strategi`. |
...
4. Gap wawancara pemilik tertutup sebagian oleh W-PM-20260706, sedangkan gap data kinerja terbaru, responden pelanggan terbatas, dan wawancara kompetitor merata tetap dicatat sebagai keterbatasan.
