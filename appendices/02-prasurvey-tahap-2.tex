...
\begin{table}[h!]
    ...
    \label{tab:stp_prasurvey2}
    \begin{tabularx}{\textwidth}{p{2.8cm}YY}
        \toprule
        \textbf{Komponen} & \textbf{Indikasi Awal}                                                                                                                                 & \textbf{Dasar Data}                                                                                                          \\
        \midrule
        Segmentasi        & Konsumen \textit{online food delivery} yang memesan makanan siap santap pada area layanan GrabFood, dengan komposisi pelanggan baru, pelanggan ulang, dan pelanggan yang diaktivasi kembali & Komposisi pelanggan menunjukkan 55\% \textit{new-comers}, 38\% \textit{repeat order}, dan 7\% \textit{reactivated user} \\
        \textit{Targeting}   & GrabFood dipilih sebagai kanal utama karena dinilai paling sesuai dengan target pasar usaha dibanding GoFood dan ShopeeFood                                                          & Pemilik menyebut GrabFood sebagai penyumbang penjualan terbesar dan paling sesuai dengan segmen pasar usaha                \\
        \textit{Positioning} & Nasi Gerilya diarahkan sebagai rumah makan nasi padang dengan rasa otentik, \textit{brand recognition} yang kuat, produk unggulan jelas, dan dukungan promo platform                 & Pemilik menekankan rasa otentik dan \textit{brand recognition}; observasi platform menunjukkan menu unggulan dan promo aktif \\
        \bottomrule
    \end{tabularx}
    \tablesource{Wawancara awal dengan pemilik usaha; diolah peneliti (2026).}
\end{table}
...
\FloatBarrier
Tabel~\ref{tab:profil_prasurvey2}, Tabel~\ref{tab:prasurvey2_grabfood}, Tabel~\ref{tab:stp_prasurvey2}, dan Tabel~\ref{tab:prasurvey2_pelanggan} menunjukkan bahwa pra-survei tahap 2 memberikan data awal mengenai identitas usaha, alasan pemilihan platform utama, indikasi STP awal, serta perubahan komposisi pelanggan dari periode sebelumnya ke periode saat ini. Pemilik usaha mengaitkan perubahan komposisi pelanggan tersebut dengan pelaksanaan \textit{marketing plan high season}.
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{lY}
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan pra-survei tahap 2 (2026).}
\end{table}
