...
Instrumen angket tertutup ini disusun untuk memperoleh penilaian kuantitatif mengenai tingkat kepentingan (bobot) dan tingkat kinerja/respons (rating) terhadap faktor internal dan eksternal Rumah Makan Nasi Gerilya. Petunjuk pengisian dan format instrumen disajikan pada Tabel~\ref{tab:instrumen-angket-ifas} dan Tabel~\ref{tab:instrumen-angket-efas}. Petunjuk Pengisian Angket:
\begin{enumerate}
