...
Data observasi platform, kompetitor, dan perbandingan awal disajikan dalam beberapa tabel berikut.
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{lY}
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan pra-survei tahap 1 (2026).}
\end{table}
