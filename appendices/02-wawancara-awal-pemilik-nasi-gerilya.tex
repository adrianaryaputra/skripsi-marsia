...
Tabel berikut menyajikan daftar pertanyaan pra-survei dan jawaban pemilik usaha berdasarkan hasil wawancara awal.
    ...
    {\scriptsize
        ...
        \begin{longtable}{|>{\centering\arraybackslash}p{0.7cm}|p{4.4cm}|p{7.8cm}|}
            ...
            \midrule
            \endfirsthead
            \multicolumn{3}{l}{\textbf{Lanjutan Tabel \WawancaraAwalNomor}}                                                                                                                                                                                                                                                                                                                                                                                                                         \\[2pt]
            \toprule
            \textbf{No.} & \textbf{Pertanyaan}                                                                                                            & \textbf{Jawaban Pemilik}                                                                                                                                                                                                                                                                                                                      \\ \hline
            \midrule
            \endhead
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|J|Y|}
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Wawancara awal dengan pemilik usaha; diolah peneliti (2026).}
\end{table}
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}{|J|Y|}
        ...
        Kontribusi terhadap penjualan & Disebut sebagai penyumbang penjualan terbesar                                                                   \\ \hline
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}{|Z{2.8cm}|Y|Y|}
        ...
        \textit{Targeting}   & GrabFood dipilih sebagai kanal utama karena dinilai paling sesuai dengan target pasar usaha dibanding GoFood dan ShopeeFood                                                                 & Pemilik menyebut GrabFood sebagai penyumbang penjualan terbesar dan paling sesuai dengan segmen pasar usaha                  \\ \hline
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}{|V|c|c|c|}
        \toprule
        \textbf{Kategori Pelanggan} & \textbf{Periode Sebelumnya} & \textbf{Saat Ini} & \textbf{Perubahan} \\ \hline
        \midrule
...
\FloatBarrier
Tabel~\ref{tab:profil_wawancara_awal}, Tabel~\ref{tab:wawancara_platform}, Tabel~\ref{tab:stp_wawancara_awal}, dan Tabel~\ref{tab:komposisi_pelanggan_wawancara} menunjukkan bahwa wawancara awal memberikan data mengenai identitas usaha, alasan pemilihan platform utama, indikasi STP awal, serta perubahan komposisi pelanggan dari periode sebelumnya ke periode saat ini. Pemilik usaha mengaitkan perubahan komposisi pelanggan tersebut dengan pelaksanaan \textit{marketing plan high season}.
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}{|J|Y|}
        ...
        \midrule
        \textit{Strengths}     & Rasa produk dinilai otentik; \textit{brand recognition} dinilai cukup kuat; GrabFood disebut sebagai penyumbang terbesar penjualan; terdapat produk unggulan berupa dendeng dan ayam pop putih; usaha mendapat dukungan program platform                                                                     \\ \hline
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan wawancara awal dengan pemilik usaha (2026).}
\end{table}
...
% Hasil wawancara awal pemilik digunakan sebagai dasar untuk:
% \begin{enumerate}[nosep]
%     \item memperdalam identifikasi faktor internal dan eksternal usaha;
%     \item melengkapi hasil observasi GrabFood;
