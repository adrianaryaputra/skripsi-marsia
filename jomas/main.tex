...
To systematically analyze digital service operations and complaint mechanisms, this study operationalizes the core constructs of Electronic Service Quality (\textit{E-S-QUAL}) and Electronic Service Recovery Quality (\textit{E-REC-S-QUAL}) formulated by \textcite{parasuraman2005esqual}, integrated with servicescape and service operations principles \parencite{bitner1992servicescapes,chase1994failsafe,smith1999servicerecovery}. Table~\ref{tab:operational-dimensions} delineates the research constructs, theoretical dimensions, foundational literature, and empirical fieldwork indicators investigated in this case study.
