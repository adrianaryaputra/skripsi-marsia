...
\midrule
Credibility & Triangulated multi-source field engagement & 4,584 reviews; \mbox{K01--K07} & Cross-referencing review logs with kitchen checks; member-checks with K01 and K02 \\
Transferability & Contextual multi-channel operations audit & Store metrics; \mbox{K08, K09} & Documenting kitchen layout, counter setup, 50\% app share, and food packaging \\
Dependability & Systematic operational audit trail stability & Audio logs, POS data & Standardized E-S-QUAL coding scheme; peer debriefing with academic advisors \\
Confirmability & Reflexive tracing of authentic field evidence & Informants \mbox{K01--K09} & Grounding inferences in verbatim quotes; cross-checking with competitor data \\
\bottomrule
\end{tabularx}
\end{table}
...
This study advances service operations and digital platform literature in three key aspects. First, it refines the E-S-QUAL framework \parencite{parasuraman2005esqual} within food delivery ecosystems by establishing that fulfillment accuracy acts as an absolute hygiene prerequisite rather than an incremental satisfier. Second, by synthesizing Expectation-Disconfirmation Theory \parencite{oliver1980cognition} with Asymmetric Attribute Performance \parencite{mittal1998asymmetric}, this research explains the micro-mechanisms whereby low-cost peripheral omissions (such as a Rp1,100 gravy pouch) induce severe negative disconfirmation and disproportionate 1-star rating penalties. Third, this study operationalizes poka-yoke mistake-proofing \parencite{chase1994failsafe} and servicescape decoupling \parencite{bitner1992servicescapes} within resource-constrained small food enterprises, demonstrating that spatial flow separation and structured dual-checks resolve physical-digital interface friction without major capital investments.

\subsection{Limitations and Future Research}
This study is bounded by its single-case design focused on an authentic Padang culinary establishment in Medan City operating on GrabFood. While a single-case investigation offers rich, granular insights into operational mechanisms, the findings reflect specific cuisine attributes, including high reliance on liquid gravies and separate packaging pouches.

Future research should extend this empirical inquiry through multi-case comparative designs across diverse culinary formats, such as beverage kiosks and fast-food chains. Comparative studies examining multi-platform fulfillment dynamics across GrabFood, GoFood, and ShopeeFood would clarify platform-specific queue friction. Furthermore, longitudinal empirical tracking of defect rate reductions, net merchant margin improvements, and customer repeat order intervals following poka-yoke deployment would provide valuable operational benchmarks for digital restaurant management.

\section{ACKNOWLEDGMENTS}
We express our sincere gratitude to the management, kitchen personnel, and frontline staff of Nasi Gerilya Restaurant Medan for their transparent collaboration during empirical fieldwork. We also acknowledge the APINDO UMKM Merdeka program and the Department of Management, Faculty of Economics and Business, Universitas Sumatera Utara, for institutional support throughout this research.
