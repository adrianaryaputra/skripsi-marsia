...
\begin{tabularx}{\textwidth}{l c c c c c X}
\toprule
\textbf{Keyword Cluster (Indonesian / English)} & \textbf{Mentions} & \textbf{Share} & \textbf{Stars ($1^*/2^*/3^*$)} & \textbf{Mean} & \textbf{Penalty} & \textbf{Underlying Operational Failure Mechanism} \\
\midrule
\textit{"kuah", "bumbu basah"} (gravy / curry sauce) & 58 & 22.3\% & 34 / 16 / 8 & 1.55 & $-3.15$ & Curry gravy omitted from package; dry meal experience \\
\textit{"sambal", "lado mudo"} (chili / sambal cup) & 41 & 15.8\% & 22 / 12 / 7 & 1.63 & $-3.07$ & Sambal pouch forgotten; loss of signature flavor profile \\
\textit{"salah menu", "ketukar"} (swapped / wrong item) & 47 & 18.1\% & 39 / 6 / 2 & 1.21 & $-3.49$ & Mismatched 4-digit POS ticket; wrong protein received \\
\textit{"lama", "nunggu", "antri"} (waiting time / delay) & 44 & 16.9\% & 11 / 12 / 21 & 2.23 & $-2.47$ & Courier waits $>20$ min at counter; late delivery \\
\textit{"tumpah", "bocor"} (gravy spillage / leaking) & 31 & 11.9\% & 15 / 9 / 7 & 1.74 & $-2.96$ & Single-knot plastic pouch ruptured inside carrier bag \\
\textit{"dingin", "anyep"} (cold food / loss of heat) & 24 & 9.2\% & 3 / 6 / 15 & 2.50 & $-2.20$ & Thermal dissipation from dispatch delay and transit time \\
\textit{"habis", "batal"} (catalog stockout / cancelled) & 15 & 5.8\% & 11 / 3 / 1 & 1.33 & $-3.37$ & Depleted dish ordered; cashier phone cancellation \\
\midrule
\textbf{Total Explicit Grievance Mentions} & \textbf{260} & \textbf{100.0\%} & \textbf{135 / 64 / 61} & \textbf{1.69} & $\mathbf{-3.01}$ & \textbf{Coded across 308 critical reviews ($\le 3$ stars)} \\
\bottomrule
\end{tabularx}
\end{table}
