...
\begin{longtable}{|>{\raggedright\arraybackslash}p{2.8cm}|>{\raggedright\arraybackslash}p{6.1cm}|>{\raggedright\arraybackslash}p{4.5cm}|>{\raggedright\arraybackslash}p{8.3cm}|}
\caption{Penelitian Terdahulu yang Relevan}\label{tab:penelitian-terdahulu}\\
\hline
\textbf{Nama (Tahun)} & \textbf{Judul Penelitian} & \textbf{Metode Analisisnya} & \textbf{Hasil Penelitiannya} \\
\hline
\endfirsthead
\hline
\textbf{Nama (Tahun)} & \textbf{Judul Penelitian} & \textbf{Metode Analisisnya} & \textbf{Hasil Penelitiannya} \\
