...
Bab ini menyajikan hasil pengolahan data lapangan mengenai strategi pemasaran Rumah Makan Nasi Gerilya pada platform GrabFood. Data yang dianalisis meliputi observasi GrabFood Nasi Gerilya dan kompetitor, transkrip wawancara pegawai Nasi Gerilya, wawancara intern \textit{business consultant} Nasi Gerilya, rekap wawancara kompetitor, angket pelanggan, dokumentasi kinerja, serta data pra-survei yang sudah dikodekan sebagai konteks awal. Karena transkrip wawancara pemilik utama belum tersedia dalam kumpulan data penelitian utama, informasi pemilik yang digunakan pada bab ini dibatasi pada wawancara awal dan dokumentasi yang sudah tercantum pada lampiran sebelumnya. Temuan diberi kode agar setiap faktor SWOT, IFAS, EFAS, dan strategi yang dirumuskan dapat ditelusuri kembali ke sumber data.
...
Data penelitian utama yang sudah tersedia terdiri atas transkrip pegawai Nasi Gerilya, wawancara intern \textit{business consultant}, rekap kompetitor, angket pelanggan, observasi GrabFood, dan dokumentasi kinerja. Ringkasan data disajikan pada Tabel~\ref{tab:ringkasan-data-penelitian-utama-bab4}.
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|Z{2.8cm}|Y|Y|Y|}
        \toprule
        \textbf{Jenis Data} & \textbf{Sumber} & \textbf{Status} & \textbf{Kegunaan Analisis} \\ \hline
        \midrule
        Wawancara pegawai & Bella sebagai pihak dapur/leader dan Ririn sebagai kasir/checker & Tersedia dalam transkrip dan diringkas menjadi kode TW-KR dan TW-AD & Menjelaskan alur operasional, kekuatan produk, SOP, stok, packing, driver, promo, dan kendala layanan. \\ \hline
        Wawancara intern \textit{business consultant} & Mahasiswa magang IT/Sistem Informasi melalui program APINDO UMKM Merdeka & Tersedia dalam transkrip dan dikodekan menjadi W-BC-01--W-BC-21 & Menjelaskan kebutuhan digitalisasi internal, sistem antrean, menu digital, stamp digital, target pelanggan, positioning, indikator evaluasi, dan prioritas strategi operasional. \\ \hline
        Wawancara kompetitor & Pondok Krakatau dan Istana Krakatau & Tersedia sebagai rekap manual dan dikodekan menjadi TW-KP-PK serta TW-KP-IK & Menjadi pembanding strategi harga, promo, rasa, layanan cepat, stok, packing, dan pembeda kompetitor. \\ \hline
        Angket pelanggan & Reyza, Alip, dan Ojan & Tersedia dalam file CSV dan dikodekan menjadi TS-PL & Menggali alasan membeli, menu favorit, persepsi harga/promo, porsi, kemasan, keluhan, repeat order, dan pembanding kompetitor. \\ \hline
        Observasi GrabFood & Nasi Gerilya tanggal 13 Juni 2026 & Tersedia 76 bukti visual dan kode TO-GF-01--TO-GF-08 & Menunjukkan reputasi digital, promo, menu, harga, ketersediaan, dan ulasan pelanggan. \\ \hline
        Observasi kompetitor & Lima merchant pembanding tanggal 19--20 Juni 2026 & Tersedia 209 bukti visual dan kode TO-KP-01--TO-KP-07 & Menjelaskan posisi Nasi Gerilya terhadap rating, jumlah penilaian, jarak, harga, promo, dan tema ulasan pesaing. \\ \hline
        Dokumentasi kinerja & Data indeks penjualan, AOV, kunjungan, dan kompetitor & Tersedia pada lampiran dokumentasi kinerja & Menjadi konteks bahwa penjualan dan indeks kompetitor perlu dijelaskan melalui strategi pemasaran dan pengalaman pelanggan. \\ \hline
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan data penelitian utama (2026).}
\end{table}

\subsection{Konteks Pra-Survei dan Batas Klaim Analisis}
Selain data penelitian utama, analisis juga menggunakan data pra-survei sebagai konteks awal. Data pra-survei tidak ditempatkan sebagai pengganti data lapangan Juni--Juli 2026, tetapi sebagai bukti pendahuluan untuk menjelaskan alasan fokus penelitian, arah penyusunan instrumen, dan penguat triangulasi jika temanya muncul kembali pada data utama. Koding pra-survei terdiri atas 128 kode, yaitu 24 kode wawancara awal pemilik, 39 kode observasi GrabFood awal, 41 kode dokumentasi kinerja, dan 24 kode foto produk/storefront. Ringkasan pemakaian data pra-survei disajikan pada Tabel~\ref{tab:konteks-prasurvei-bab4}.
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|Z{2.2cm}|Y|Y|Y|}
        ...
        PS-KIN & Data kinerja awal menunjukkan penjualan bulanan mencapai puncak pada Maret 2025 lalu cenderung melemah sampai November 2025; indeks Nasi Gerilya turun dari 100,0 menjadi 70,4 pada Juli--Oktober 2025 atau berubah -29,6\%; AOV dan kunjungan naik pada sebagian periode tetapi penjualan dan indeks relatif melemah. & Menjelaskan urgensi strategi peningkatan penjualan, kebutuhan menjaga konversi, repeat order, harga, promo, dan pengalaman layanan. & Tidak digunakan sebagai bukti peningkatan atau penurunan penjualan terbaru tahun 2026 karena dataset kinerja terbaru belum tersedia. \\ \hline
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan koding pra-survei (2026).}
\end{table}

Berdasarkan protokol batas klaim, temuan Bab IV dibaca sebagai analisis kualitatif berbasis triangulasi. Klaim yang boleh digunakan adalah bahwa strategi yang dirumuskan berpotensi mendukung peningkatan penjualan melalui perbaikan keputusan pembelian, pengalaman layanan, repeat order, dan efisiensi proses. Bab ini tidak menyatakan bahwa strategi telah terbukti meningkatkan penjualan secara kuantitatif, karena data kinerja GrabFood terbaru dan wawancara pemilik utama terbaru belum tersedia. Dengan demikian, data pra-survei dipakai sebagai penguat konteks, sedangkan keputusan analisis utama tetap disandarkan pada data lapangan yang sudah dikodekan dan bukti visual yang tersedia.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{1.7cm}|Y|Z{2.5cm}|Z{2.1cm}|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti dari transkrip wawancara pegawai Nasi Gerilya (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{2.0cm}|Y|Z{2.7cm}|Z{2.1cm}|}
        \toprule
        \textbf{Kode} & \textbf{Temuan} & \textbf{Tema} & \textbf{Kategori} \\ \hline
        \midrule
        ...
        W-BC-05, W-BC-11, W-BC-16 & Menu digital, payment gateway, stamp digital, dan pengelolaan data pelanggan diarahkan untuk mempercepat layanan dine in/take away dan membangun loyalitas di luar platform online. & Process, physical evidence, promotion & Peluang/kekuatan \\ \hline
        ...
        W-BC-09--W-BC-10 & Ayam pop layak dijadikan hero menu, sedangkan promo perlu dihitung agar tetap sesuai harga jual dan HPP. & Product, price, promotion & Kekuatan/ancaman \\ \hline
        W-BC-12--W-BC-14 & Promosi perlu mendukung sistem digital dan loyalitas; pembeda Nasi Gerilya berada pada rasa lauk, jumlah pelanggan, dan kemauan UMKM untuk berbenah melalui sistem digital. & Promotion, product, process & Kekuatan/peluang \\ \hline
        W-BC-15--W-BC-17 & Kendala layanan paling berat terjadi saat makan siang, hari Minggu, dan hari raya; ancaman berasal dari persaingan kuliner, biaya platform, kenaikan bahan baku, dan sensitivitas harga pelanggan. & Process, price, competition & Kelemahan/ancaman \\ \hline
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti dari transkrip wawancara intern \textit{business consultant} Nasi Gerilya (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{1.9cm}|Y|Z{2.6cm}|Z{2.1cm}|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti dari rekap wawancara Pondok Krakatau dan Istana Krakatau (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{1.7cm}|Y|Z{2.6cm}|Z{2.1cm}|}
        \toprule
        \textbf{Kode} & \textbf{Temuan} & \textbf{Tema} & \textbf{Kategori} \\ \hline
        \midrule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti dari angket pelanggan GrabFood Nasi Gerilya (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{0.95}
    \begin{tabularx}{\textwidth}{|Z{1.8cm}|Z{3.1cm}|Y|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Observasi GrabFood Nasi Gerilya pada 13 Juni 2026; diolah peneliti (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{3.0cm}|Z{1.3cm}|Z{2.2cm}|Z{1.4cm}|Y|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti dari observasi GrabFood Nasi Gerilya dan kompetitor (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{3cm}|Z{3cm}|Z{3.2cm}|Y|}
        \toprule
...
Analisis STP menunjukkan bahwa Nasi Gerilya melayani pelanggan GrabFood yang mencari makanan berat, praktis, mengenyangkan, dan dapat dipercaya melalui tampilan digital. Ringkasan STP disajikan pada Tabel~\ref{tab:analisis-stp-bab4}.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{0.95}
    \begin{tabularx}{\textwidth}{|Z{2.6cm}|Y|Y|Y|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan hasil penelitian utama (2026).}
\end{table}

\subsection{Analisis Bauran Pemasaran 7P}
Analisis 7P menunjukkan bahwa produk dan bukti digital Nasi Gerilya sudah cukup kuat, tetapi proses layanan menjadi titik paling penting untuk diperbaiki. Ringkasan 7P disajikan pada Tabel~\ref{tab:analisis-7p-bab4}.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{0.95}
    \begin{tabularx}{\textwidth}{|Z{2.7cm}|Y|Y|Y|}
        \toprule
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{1.2cm}|Y|Y|Y|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan koding temuan lapangan (2026).}
\end{table}

\section{Triangulasi Data}
Triangulasi dilakukan dengan membandingkan temuan dari pegawai, intern \textit{business consultant}, pelanggan, kompetitor, observasi platform, dan dokumentasi kinerja. Hasil triangulasi disajikan pada Tabel~\ref{tab:triangulasi-bab4}.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{2.4cm}|Y|Y|Y|Z{1.8cm}|}
        \toprule
        ...
        Data pemilik utama penelitian belum tersedia. & Inventaris data & Pemeriksaan dokumen & Juli 2026 & Perlu data tambahan bila ingin memperkuat keputusan margin/biaya promo \\ \hline
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan triangulasi data penelitian utama dan pra-survei (2026).}
\end{table}

\section{Matriks IFAS dan EFAS}
Penyusunan IFAS dan EFAS mengikuti prosedur Bab III. Bobot ditentukan berdasarkan kekuatan bukti, frekuensi kemunculan tema, dan dampak terhadap penjualan atau pembelian ulang. Rating internal menunjukkan tingkat kekuatan atau kelemahan, sedangkan rating eksternal menunjukkan kemampuan respons usaha terhadap peluang atau ancaman. Karena belum ada validasi pemilik utama terbaru, bobot dan rating pada matriks ini ditulis sebagai penilaian peneliti berdasarkan triangulasi sumber, bukan sebagai keputusan final pemilik usaha.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{0.95}
    \begin{tabularx}{\textwidth}{|Z{1cm}|Y|c|c|c|}
        \toprule
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan hasil penelitian utama dan konteks pra-survei (2026).}
\end{table}
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|Z{2.4cm}|Y|Y|}
        ...
        \bottomrule
    \end{tabularx}
    \tablesource{Diolah peneliti berdasarkan hasil IFAS dan EFAS (2026).}
\end{table}

\section{Prioritas Strategi Pemasaran untuk Meningkatkan Penjualan}
Berdasarkan matriks SWOT, prioritas strategi disusun dari strategi yang memiliki hubungan paling langsung dengan penjualan, pembelian ulang, dan daya saing di GrabFood. Prioritas strategi disajikan pada Tabel~\ref{tab:prioritas-strategi-bab4}.
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{0.92}
    \begin{tabularx}{\textwidth}{|Z{1.2cm}|Y|Y|Y|Y|}
        \toprule
        \textbf{Prioritas} & \textbf{Strategi} & \textbf{Dasar Data} & \textbf{Dampak yang Diharapkan} & \textbf{Alasan Kelayakan} \\ \hline
        \midrule
