...
Justifikasi bobot disajikan secara rinci pada Tabel~\ref{tab:justifikasi-bobot-ifas-efas-bab4}. Penjelasan ini diperlukan agar pembobotan tidak terlihat sebagai angka arbitrer, melainkan sebagai hasil interpretasi terhadap bukti lapangan, pola koding, dan dampak strategis masing-masing faktor \parencite{hendrizon2024madayacoffee,rangkuti2016analisisSWOT}.

\begingroup
    \scriptsize
    \setlength{\tabcolsep}{2pt}
    \renewcommand{\arraystretch}{1.02}
    \begin{longtable}{|Z{0.9cm}|Z{0.8cm}|C{0.9cm}|L{9.8cm}|}
        ...
        \endfoot
        \bottomrule
        \multicolumn{4}{@{}L{\textwidth}@{}}{\footnotesize Sumber: Diolah peneliti berdasarkan triangulasi temuan lapangan, koding pra-survei, dan konsep IFAS/EFAS \parencite{rangkuti2016analisisSWOT,david2023strategicmanagement,hendrizon2024madayacoffee}.}\\
        \endlastfoot
        ...
        EFAS & T5 & 0,06 & Keunggulan spesifik kompetitor pada rasa, layanan cepat, sambal, porsi, dan menu diberi bobot terendah karena bukti pendalaman kompetitor masih terbatas dan sebagian ancamannya sudah tercermin pada reputasi digital serta perbandingan harga/promo. \\ \hline
    \end{longtable}
\endgroup
