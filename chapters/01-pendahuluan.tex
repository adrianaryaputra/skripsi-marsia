...
\begingroup
    ...
    \begin{longtable}{|L{9.4cm}|R{3.0cm}|}
        ...
        \endfoot
        \bottomrule
        \multicolumn{2}{@{}L{\textwidth}@{}}{\footnotesize Sumber: Observasi platform GrabFood pada 04 April 2026; diolah peneliti (2026).}\\
        \endlastfoot
...
\begingroup
    ...
    \begin{longtable}{|L{4.05cm}|C{2.55cm}|C{1.55cm}|L{4.65cm}|}
        ...
        \endfoot
        \bottomrule
        \multicolumn{4}{@{}L{\textwidth}@{}}{\footnotesize Sumber: Observasi awal platform GrabFood pada 04 April 2026; diolah peneliti (2026).}\\
        \endlastfoot
